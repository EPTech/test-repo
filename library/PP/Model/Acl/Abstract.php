 ...
 */
abstract class PP_Model_Acl_Abstract extends PP_Model_Abstract implements PP_Model_Acl_Interface, Zend_Acl_Resource_Interface
{
    /**
     * @var Zend_Acl
     */
    ...
    public function setIdentity($identity)
    {
        if (is_array($identity)) {
            if (!isset($identity['role_id'])) {
                $identity['role_id'] = 'Guest';
            }
            $identity = new Zend_Acl_Role($identity['role_id']);
            ...
            var_dump($identity);
            throw new PP_Model_Exception('Invalid identity provided');
        }
