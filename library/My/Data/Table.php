...
class My_Data_Table {
	...
	protected $_defaultDisplayLength = '10';
	...
	public function __construct(Zend_Db_Table_Select $select, array $displayColumns = null, array $searchColumns = null, $options = array()){
		$this->_select = $select;
	...
	public function render(){
		...
		$html = $helper->htmlTable($this->_displayColumns, $this->getData());
		return $html->render();
	}
